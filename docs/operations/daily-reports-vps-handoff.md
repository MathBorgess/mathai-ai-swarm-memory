...
|---|---|---|
| F0 | PR #12 mesclado | Pesquisa de quota e Access |
| F1 | PR #13 mesclado | Contratos e rotina base |
| F2 | PR #14 mesclado | Correções e validação do ciclo |
| F3 | PR #15 mesclado | Formulário, autosave e servidor |
| F4 | PR #16 mesclado | Sessão noturna e publicação |
| F5 | PR #18 mesclado | Dispatch, quota, claims e digest |
| F6 | PR #17 mesclado | Discovery somente leitura |
| Pesos RES (wiki) | PR #88 mesclado em `mathai-wiki` | `brand/metrics/res-weights.json` |

Para a instalação, fixar o SHA de `main` aprovado pelo dono e registrar esse SHA no inventário da VPS antes de qualquer upgrade. O prompt operacional para o agente da VPS continua no handoff da sessão; este documento contém o procedimento sem credenciais.
